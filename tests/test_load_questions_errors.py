...
def test_load_questions_invalid_file_type(invalid_file_path):
    with pytest.raises(ValueError):
        load_questions(input_file=invalid_file_path, question_type=QuestionType.MULTIPLE_CHOICE)
...
def test_load_questions_missing_question_type(shrtq_file_path):
    with pytest.raises(ValueError):
        load_questions(input_file=shrtq_file_path, question_type=None)
